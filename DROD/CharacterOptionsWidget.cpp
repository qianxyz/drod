...
{
	UINT r = min((UINT)this->pSpeechColorRedTextBox->GetNumber(), (UINT)255);
	UINT g = min((UINT)this->pSpeechColorGreenTextBox->GetNumber(), (UINT)255);
	UINT b = min((UINT)this->pSpeechColorBlueTextBox->GetNumber(), (UINT)255);
